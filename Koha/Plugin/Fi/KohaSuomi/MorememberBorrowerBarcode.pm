package Koha::Plugin::Fi::KohaSuomi::MorememberBorrowerBarcode;
...
our $metadata = {
    name            => 'IntranetUserJS: Show borrower barcode',
    author          => 'Pasi Kallinen',
    date_authored   => '2024-05-10',
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/MorememberBorrowerBarcode/";
